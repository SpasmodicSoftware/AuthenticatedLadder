...
cd minicover
dotnet minicover instrument --workdir ../ --assemblies */bin/**/*.dll --exclude-sources AuthenticatedLadder/Program.cs --exclude-sources AuthenticatedLadder/Startup.cs --exclude-sources AuthenticatedLadder/Migrations/* --sources AuthenticatedLadder/**/*.cs
cd ..
