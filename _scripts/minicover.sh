...
cd minicover
dotnet minicover instrument --workdir ../ --assemblies */bin/**/*.dll --exclude-sources AuthenticatedLadder/Pogram.cs --exclude-sources AuthenticatedLadder/Startup.cs --sources AuthenticatedLadder/**/*.cs
cd ..
